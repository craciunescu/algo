...
# Testing
import unittest
from U1.src.e6 import is_perfect_naive, is_perfect_optimized
...
class TestPerfectMethods(unittest.TestCase):
    ...
    def test_is_perfect_naive04(self):
        """ Test is_perfect_naive """
        self.assertTrue(is_perfect_naive(8128))

    def test_is_perfect_naive05(self):
        """ Test is_perfect_naive """
        self.assertFalse(is_perfect_naive(4))

    def test_is_perfect_naive06(self):
        """ Test is_perfect_naive """
        self.assertFalse(is_perfect_naive(9002))

    def test_is_perfect_naive07(self):
        """ Test is_perfect_naive """
        self.assertFalse(is_perfect_naive(30000))

    def test_is_perfect_naive08(self):
        """ Test is_perfect_naive """
        self.assertFalse(is_perfect_naive(123456))
    ...
    def test_is_perfect_optimized04(self):
        """ Test is_perfect_optimized """
        self.assertTrue(is_perfect_optimized(8128))

    def test_is_perfect_optimized05(self):
        """ Test is_perfect_optimized """
        self.assertFalse(is_perfect_optimized(4))

    def test_is_perfect_optimized06(self):
        """ Test is_perfect_optimized """
        self.assertFalse(is_perfect_optimized(9002))

    def test_is_perfect_optimized07(self):
        """ Test is_perfect_optimized """
        self.assertFalse(is_perfect_optimized(30000))

    def test_is_perfect_optimized08(self):
        """ Test is_perfect_optimized """
        self.assertFalse(is_perfect_optimized(123456))
